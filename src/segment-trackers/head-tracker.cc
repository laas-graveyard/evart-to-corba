...
{
  boost::mt19937 gen;
} // end of namespace head.

TRACKED_SEGMENT_IMPL (HeadTracker, "head", "origin");

HeadTracker::HeadTracker (Application& app)
  : TrackedSegment (app,
		    HeadTracker::BODY_NAME,
		    HeadTracker::BODY_NAME,
		    HeadTracker::SEGMENT_NAME,
		    3 + 2, 1)
{}
...
void
HeadTracker::computeSignal (const evas_msg_t* msg)
{
