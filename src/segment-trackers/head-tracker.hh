...
#ifndef EVART_TO_CORBA_SEGMENT_HEAD_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_HEAD_TRACKER_HH
...
/// \brief Track HRP-2 head.
class HeadTracker : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (HeadTracker);
public:
  HeadTracker (Application& app);
  ~HeadTracker ();
...
#endif //! EVART_TO_CORBA_SEGMENT_HEAD_TRACKER_HH
