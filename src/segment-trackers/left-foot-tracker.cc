...
namespace leftFootTracker
{
  boost::mt19937 gen;
} // end of namespace leftFootTracker.

TRACKED_SEGMENT_IMPL (LeftFootTracker, "left-foot", "origin");

LeftFootTracker::LeftFootTracker (Application& app)
  : TrackedSegment (app,
...
void
LeftFootTracker::computeSignal (const evas_msg_t* msg)
{
...
void
LeftFootTracker::simulateSignal ()
{
