...
#include "segment-bar-tracker.hh"
...
namespace barTrackerSegment
{
  boost::mt19937 gen;
} // end of namespace barTrackerSegment.

TRACKED_SEGMENT_IMPL (BarTrackerSegment, "bar", "origin");

BarTrackerSegment::BarTrackerSegment (Application& app)
  : TrackedSegment (app,
...
void
BarTrackerSegment::computeSignal (const evas_msg_t* msg)
{
...
void
BarTrackerSegment::simulateSignal ()
{
  ...
  boost::variate_generator<boost::mt19937&, boost::normal_distribution<> >
    die (barTrackerSegment::gen, dist);
