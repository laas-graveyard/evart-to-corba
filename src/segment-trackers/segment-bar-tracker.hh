...
#ifndef EVART_TO_CORBA_SEGMENT_BAR_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_BAR_TRACKER_HH
...
class BarTrackerSegment : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (BarTrackerSegment);
public:
  BarTrackerSegment (Application& app);
  ~BarTrackerSegment ();
...
#endif //! EVART_TO_CORBA_SEGMENT_BAR_TRACKER_HH
