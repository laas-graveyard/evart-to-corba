...
#include "segment-chair-tracker.hh"
...
namespace chairTrackerSegment
{
  boost::mt19937 gen;
} // end of namespace chairTrackerSegment.

TRACKED_SEGMENT_IMPL (ChairTrackerSegment, "chair", "origin");

ChairTrackerSegment::ChairTrackerSegment (Application& app)
  : TrackedSegment (app,
...
void
ChairTrackerSegment::computeSignal (const evas_msg_t* msg)
{
...
void
ChairTrackerSegment::simulateSignal ()
{
  ...
  boost::variate_generator<boost::mt19937&, boost::normal_distribution<> >
    die (chairTrackerSegment::gen, dist);
