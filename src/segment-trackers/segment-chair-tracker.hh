...
#ifndef EVART_TO_CORBA_SEGMENT_CHAIR_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_CHAIR_TRACKER_HH
...
class ChairTrackerSegment : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (ChairTrackerSegment);
public:
  ChairTrackerSegment (Application& app);
  ~ChairTrackerSegment ();
...
#endif //! EVART_TO_CORBA_SEGMENT_CHAIR_TRACKER_HH
