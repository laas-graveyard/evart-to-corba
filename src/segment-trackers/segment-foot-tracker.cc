...
#include "segment-foot-tracker.hh"
...
namespace footTrackerSegment
{
  boost::mt19937 gen;
} // end of namespace footTrackerSegment.

TRACKED_SEGMENT_IMPL (FootTrackerSegment, "left-foot", "origin");

FootTrackerSegment::FootTrackerSegment (Application& app)
  : TrackedSegment (app,
		    FootTrackerSegment::BODY_NAME,
		    FootTrackerSegment::BODY_NAME,
		    FootTrackerSegment::SEGMENT_NAME,
                    7, 1)
{}

FootTrackerSegment::~FootTrackerSegment ()
{}


void
FootTrackerSegment::computeSignal (const evas_msg_t* msg)
{
...
void
FootTrackerSegment::simulateSignal ()
{
  ...
  boost::variate_generator<boost::mt19937&, boost::normal_distribution<> >
    die (footTrackerSegment::gen, dist);
