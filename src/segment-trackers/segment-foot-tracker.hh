...
#ifndef EVART_TO_CORBA_SEGMENT_FOOT_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_FOOT_TRACKER_HH
...
class FootTrackerSegment : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (FootTrackerSegment);
public:
  FootTrackerSegment (Application& app);
  ~FootTrackerSegment ();
...
#endif //! EVART_TO_CORBA_SEGMENT_FOOT_TRACKER_HH
