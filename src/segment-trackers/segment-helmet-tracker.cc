...
#include "segment-helmet-tracker.hh"
...
namespace helmetTrackerSegment
{
  boost::mt19937 gen;
} // end of namespace helmetTrackerSegment.

TRACKED_SEGMENT_IMPL (HelmetTrackerSegment, "helmet", "origin");

HelmetTrackerSegment::HelmetTrackerSegment (Application& app)
  : TrackedSegment (app,
		    HelmetTrackerSegment::BODY_NAME,
		    HelmetTrackerSegment::BODY_NAME,
		    HelmetTrackerSegment::SEGMENT_NAME,
                    6, 1)
{}

HelmetTrackerSegment::~HelmetTrackerSegment ()
{}


void
HelmetTrackerSegment::computeSignal (const evas_msg_t* msg)
{
...
void
HelmetTrackerSegment::simulateSignal ()
{
  ...
  boost::variate_generator<boost::mt19937&, boost::normal_distribution<> >
    die (helmetTrackerSegment::gen, dist);
