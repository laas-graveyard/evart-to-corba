...
#ifndef EVART_TO_CORBA_SEGMENT_HELMET_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_HELMET_TRACKER_HH
...
class HelmetTrackerSegment : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (HelmetTrackerSegment);
public:
  HelmetTrackerSegment (Application& app);
  ~HelmetTrackerSegment ();

  virtual void computeSignal (const evas_msg_t* msg);
  virtual void simulateSignal ();
};

#endif //! EVART_TO_CORBA_SEGMENT_HELMET_TRACKER_HH
