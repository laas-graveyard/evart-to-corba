...
#include "segment-room-tracker.hh"
...
namespace roomTrackerSegment
{
  boost::mt19937 gen;
} // end of namespace roomTrackerSegment.

TRACKED_SEGMENT_IMPL (RoomTrackerSegment, "room", "origin");

RoomTrackerSegment::RoomTrackerSegment (Application& app)
  : TrackedSegment (app,
		    RoomTrackerSegment::BODY_NAME,
		    RoomTrackerSegment::BODY_NAME,
		    RoomTrackerSegment::SEGMENT_NAME,
                    7, 1)
{}

RoomTrackerSegment::~RoomTrackerSegment ()
{}


void
RoomTrackerSegment::computeSignal (const evas_msg_t* msg)
{
...
void
RoomTrackerSegment::simulateSignal ()
{
  ...
  boost::variate_generator<boost::mt19937&, boost::normal_distribution<> >
    die (roomTrackerSegment::gen, dist);
