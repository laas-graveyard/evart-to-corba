...
#ifndef EVART_TO_CORBA_SEGMENT_ROOM_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_ROOM_TRACKER_HH
...
class RoomTrackerSegment : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (RoomTrackerSegment);
public:
  RoomTrackerSegment (Application& app);
  ~RoomTrackerSegment ();
...
#endif //! EVART_TO_CORBA_SEGMENT_ROOM_TRACKER_HH
