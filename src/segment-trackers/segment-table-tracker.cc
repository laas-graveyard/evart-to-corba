...
#include "segment-table-tracker.hh"
...
namespace tableTrackerSegment
{
  boost::mt19937 gen;
} // end of namespace tableTrackerSegment.

TRACKED_SEGMENT_IMPL (TableTrackerSegment, "table", "origin");

TableTrackerSegment::TableTrackerSegment (Application& app)
  : TrackedSegment (app,
		    TableTrackerSegment::BODY_NAME,
		    TableTrackerSegment::BODY_NAME,
		    TableTrackerSegment::SEGMENT_NAME,
                    6, 1)
{}

TableTrackerSegment::~TableTrackerSegment ()
{}


void
TableTrackerSegment::computeSignal (const evas_msg_t* msg)
{
...
void
TableTrackerSegment::simulateSignal ()
{
  ...
  boost::variate_generator<boost::mt19937&, boost::normal_distribution<> >
    die (tableTrackerSegment::gen, dist);
