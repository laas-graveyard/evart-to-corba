...
#ifndef EVART_TO_CORBA_SEGMENT_TABLE_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_TABLE_TRACKER_HH
...
class TableTrackerSegment : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (TableTrackerSegment);
public:
  TableTrackerSegment (Application& app);
  ~TableTrackerSegment ();
...
#endif //! EVART_TO_CORBA_SEGMENT_TABLE_TRACKER_HH
