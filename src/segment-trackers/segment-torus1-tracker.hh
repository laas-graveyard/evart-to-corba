...
#ifndef EVART_TO_CORBA_SEGMENT_TORUS1_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_TORUS1_TRACKER_HH
...
class Torus1TrackerSegment : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (Torus1TrackerSegment);
public:
  Torus1TrackerSegment (Application& app);
  ~Torus1TrackerSegment ();

  virtual void computeSignal (const evas_msg_t* msg);
  virtual void simulateSignal ();
};

#endif //! EVART_TO_CORBA_SEGMENT_TORUS1_TRACKER_HH
