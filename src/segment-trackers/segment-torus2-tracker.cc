...
#include "segment-torus2-tracker.hh"
...
namespace torus2TrackerSegment
{
  boost::mt19937 gen;
} // end of namespace torus2TrackerSegment.

TRACKED_SEGMENT_IMPL (Torus2TrackerSegment, "torus2", "PO");

Torus2TrackerSegment::Torus2TrackerSegment (Application& app)
  : TrackedSegment (app,
		    Torus2TrackerSegment::BODY_NAME,
		    Torus2TrackerSegment::BODY_NAME,
		    Torus2TrackerSegment::SEGMENT_NAME,
                    4, 1)
{}

Torus2TrackerSegment::~Torus2TrackerSegment ()
{}


void
Torus2TrackerSegment::computeSignal (const evas_msg_t* msg)
{
...
void
Torus2TrackerSegment::simulateSignal ()
{
  ...
  boost::variate_generator<boost::mt19937&, boost::normal_distribution<> >
    die (torus2TrackerSegment::gen, dist);
