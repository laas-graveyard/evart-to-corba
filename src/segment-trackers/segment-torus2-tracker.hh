...
#ifndef EVART_TO_CORBA_SEGMENT_TORUS2_TRACKER_HH
# define EVART_TO_CORBA_SEGMENT_TORUS2_TRACKER_HH
...
class Torus2TrackerSegment : public TrackedSegment
{
  TRACKED_SEGMENT_DECL (Torus2TrackerSegment);
public:
  Torus2TrackerSegment (Application& app);
  ~Torus2TrackerSegment ();

  virtual void computeSignal (const evas_msg_t* msg);
  virtual void simulateSignal ();
};

#endif //! EVART_TO_CORBA_SEGMENT_TORUS2_TRACKER_HH
