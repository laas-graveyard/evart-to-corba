...
#ifndef EVART_TO_CORBA_BAR_TRACKER_HH
# define EVART_TO_CORBA_BAR_TRACKER_HH
...
class BarTracker : public TrackedBody
{
  TRACKED_BODY_DECL (BarTracker);
public:
  BarTracker (Application& app);
  ~BarTracker ();
...
#endif //! EVART_TO_CORBA_BAR_TRACKER_HH
