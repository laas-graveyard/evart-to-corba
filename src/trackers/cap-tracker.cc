...
{
  boost::mt19937 gen;
} // end of namespace cap

TRACKED_BODY_IMPL (CapTracker, "Cap");

CapTracker::CapTracker (Application& app)
  : TrackedBody (app, "helmetPosition", CapTracker::BODY_NAME, 4),
    fr_ (0),
    fl_ (1),
    t_ (2),
    b_ (3)
...
void
CapTracker::computeSignal (const evas_msg_t* msg)
{
