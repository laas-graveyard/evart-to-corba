...
#ifndef EVART_TO_CORBA_CHAIR_TRACKER_HH
# define EVART_TO_CORBA_CHAIR_TRACKER_HH
...
class ChairTracker : public TrackedBody
{
  TRACKED_BODY_DECL (ChairTracker);
public:
  ChairTracker (Application& app);
  ~ChairTracker ();
...
#endif //! EVART_TO_CORBA_CHAIR_TRACKER_HH
