...
TRACKED_BODY_IMPL (HelmetTracker, "helmet");

HelmetTracker::HelmetTracker (Application& app)
  : TrackedBody (app, "helmetPosition", HelmetTracker::BODY_NAME, 4),
    fr_ (0),
    fl_ (1),
    t_ (2),
    b_ (3)
...
void
HelmetTracker::computeSignal (const evas_msg_t* msg)
{
  ...
  signalOutput_[0] = t[0]*0.001;
  signalOutput_[1] = t[1]*0.001;
  signalOutput_[2] = t[2]*0.001;
  signalOutput_[3] = 0.;
  signalOutput_[4] = 0.;
  signalOutput_[5] = atan2 (ublas::norm_2 (t_- b),ublas::norm_2 (t_- b));
