...
#ifndef EVART_TO_CORBA_HELMET_HH
# define EVART_TO_CORBA_HELMET_HH
...
class Helmet : public TrackedBody
{
  TRACKED_BODY_DECL (Helmet);
public:
  Helmet (Application& app);
  ~Helmet ();
...
#endif //! EVART_TO_CORBA_HELMET_HH
