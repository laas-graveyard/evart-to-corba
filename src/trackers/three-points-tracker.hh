...
#ifndef EVART_TO_CORBA_THREE_POINTS_TRACKER_HH
# define EVART_TO_CORBA_THREE_POINTS_TRACKER_HH
...
class ThreePointsTracker : public TrackedBody
{
  TRACKED_BODY_DECL (ThreePointsTracker);
public:
  ThreePointsTracker (Application& app);
  ~ThreePointsTracker ();
